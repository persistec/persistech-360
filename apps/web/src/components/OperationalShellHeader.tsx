      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-4 sm:px-8">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-foreground/80">{context.description}</p>
          </div>

          <div className="grid gap-3 sm:grid-cols-2 xl:w-[33rem]">
            <div className="rounded-xl border border-border bg-surface px-4 py-3 shadow-sm shadow-black/5">
            ...
            <div className="rounded-xl border border-border bg-surface-elevated px-4 py-3 shadow-sm shadow-black/5">
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              ...
              <p className="mt-1 text-xs leading-5 text-foreground/80">
                Layout de administração com navegação agrupada e foco visual consistente.
              </p>
            </div>
          </div>
        </div>
