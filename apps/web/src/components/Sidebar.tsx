      ...
      <aside className="hidden h-dvh w-72 shrink-0 flex-col border-r border-border bg-surface/90 text-foreground shadow-2xl shadow-black/10 backdrop-blur md:flex">
                ...
                {section.items.map((item) => {
                  ...
                  return (
                    <li key={item.href}>
                      <Link
                        href={item.href}
                        className={`group relative flex items-center rounded-md px-3 py-2.5 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background ${
                          isActive
        ...
        <div className="shrink-0 space-y-4 border-t border-border p-5">
          <div className="rounded-lg border border-border bg-surface-muted p-4">
            ...
            <p className="mt-2 text-sm text-foreground/85">Interface interna de administração</p>
          </div>
        </div>
      </aside>
    </>
